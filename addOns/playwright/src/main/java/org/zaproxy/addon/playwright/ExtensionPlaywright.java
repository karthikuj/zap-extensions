 ...
 */
public class ExtensionPlaywright extends ExtensionAdaptor {

    // The name is public so that other extensions can access it
    public static final String NAME = "ExtensionPlaywright";

    // The i18n prefix, by default the package name - defined in one place to make it easier
    // to copy and change this example
    protected static final String PREFIX = "playwright";
    ...
    private PlaywrightAPI api;

    private static final Logger LOGGER = LogManager.getLogger(ExtensionPlaywright.class);

    public ExtensionPlaywright() {
        super(NAME);
        setI18nPrefix(PREFIX);

        String classpth = System.getProperty("java.class.path");
        String[] classpathEntries = classpth.split(System.getProperty("path.separator"));
                ...
                View.getSingleton()
                        .showWarningDialog(
                                Constant.messages.getString(
                                        ExtensionPlaywright.PREFIX + ".error.nofile",
                                        f.getAbsolutePath()));
                return;
            }
